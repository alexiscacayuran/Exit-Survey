...
if (mysqli_num_rows($res) > 0) {
    while ($row1 = mysqli_fetch_assoc($res)) {
       ...
       //extract the data choices from the concatenated answer and put it to array
        ...
        for ($x = 0; $x < $count; $x++) {
            if ($str_arr[$x] == "Pasiklaban") {
                $ctr1++;
            } else if ($str_arr[$x] == "CS Week") {
                $ctr2++;
            } else if ($str_arr[$x] == "Knowledge Festival") {
                $ctr3++;
            } else if ($str_arr[$x] == "Organization-led Quiz Bees") {
                $ctr4++;
            } else if ($str_arr[$x] == "Intramurals") {
                $ctr5++;
            } else if ($str_arr[$x] == "Tagislakas") {
                $ctr6++;
            } else if ($str_arr[$x] == "Salakniban") {
                $ctr7++;
            } else if ($str_arr[$x] == "None") {
                $ctr8++;
            } else {
                $ctr9++;
            }
    ...
    {
        {
            ...
            function (data)
            {
                ...
                var six = <?php echo $ctr7 ?>;
                var seven = <?php echo $ctr8 ?>;
                ...
                <div align="center">
                <div  id="chart-container" style="width: 350px; height: 40%; margin: 30px 80px">
