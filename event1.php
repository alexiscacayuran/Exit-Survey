...
if (mysqli_num_rows($res) > 0) {
    while ($row1 = mysqli_fetch_assoc($res)) {
        ...
        for ($x = 0; $x < $count; $x++) {
            ...
            if ($str_arr[$x] == "Lighting") {
                $ctr1++;
            } else if ($str_arr[$x] == "Computer") {
                $ctr2++;
            } else if ($str_arr[$x] == "Blackboards") {
                $ctr3++;
            } else if ($str_arr[$x] == "Projectors") {
                $ctr4++;
            } else if ($str_arr[$x] == "Room Layout") {
                $ctr5++;
            } else if ($str_arr[$x] == "Ventilation") {
                $ctr6++;
            } else if ($str_arr[$x] == "Internet Connection") {
                $ctr7++;
